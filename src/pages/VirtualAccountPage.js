      ...
      <div className="va-container">
        ...
        {peserta && peserta.length > 0 && (
          <div className="participants-card">
            <h3 className="card-title">
              <span className="card-icon">👥</span> Data Peserta
            </h3>
        ...
        <div className="payment-options-card">
          ...
          <div className="payment-options">
            ...
            >
              ...
              <div className="option-amount">{formatRupiah(dpAmount)}</div>
            </div>
          </div>
        </div>
        ...
        <div className="notes-card">
          ...
          <ul className="notes-list">
            <li>
              Pastikan nominal yang ditransfer sesuai dengan jumlah tagihan
            </li>
            <li>
              Virtual Account akan otomatis nonaktif setelah batas waktu
              berakhir
            </li>
            ...
            {paymentType === "dp" && (
              <li className="highlight">
                <strong>
                  Sisa pembayaran sebesar {formatRupiah(sisaAmount)} harus
                  dilunasi sebelum keberangkatan
                </strong>
              </li>
            )}
          </ul>
        ...
        <div className="action-buttons">
          ...
          <button className="check-button" onClick={handleViewTicket}>
            <span>🎟️</span> (Simulasi) Lihat Tiket
          </button>
        </div>
      </div>
    </div>
