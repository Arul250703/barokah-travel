...
import "../components/styles/Sukabumi.css"; // tetap pakai CSS ini biar konsisten
...
// Data statis untuk paket event/acara di Surabaya
const surabayaEventData = {
  capacityBuilding: [
    {
      id: "cb1",
      name: "Paket Standar",
...
const Surabaya = () => {
    ...
    const fetchPackages = async () => {
      try {
        const res = await axios.get(
          "http://localhost:5000/api/packages?city=Surabaya"
        );
  ...
  if (currentFilter === "paket") {
    filteredPackages = [
      ...surabayaEventData.capacityBuilding,
      ...surabayaEventData.eoWo,
    ];
  } else {
    ...
    <div className="sukabumi-page">
      <header className="detail-hero-section" style={heroBgStyle}>
        <div className="detail-hero-overlay">
          <h1 className="detail-hero-title">PAKET WISATA SURABAYA</h1>
          <p className="detail-hero-subtitle">Jawa Timur</p>
        </div>
      </header>
            ...
            <div>
              ...
              <section className="section">
                ...
                <div className="package-grid">
                  {surabayaEventData.capacityBuilding.map((pkg) => (
              ...
              <section className="section">
                ...
                <div className="package-grid">
                  {surabayaEventData.eoWo.map((pkg) => (
                    <div className="package-box" key={pkg.id}>
      ...
      <section className="custom-cta">
        ...
        <div className="cta-overlay">
          <div className="cta-text">
            ...
            <a
              href={`https://wa.me/6285930005544?text=Halo, saya tertarik dengan paket di Surabaya.`}
