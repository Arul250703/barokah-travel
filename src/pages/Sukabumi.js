...
const sukabumiData = {
  ...
  packages: [
    {
      id: "1",
      name: "Situ Gunung-Heritage Kota Sukabumi 2H1M",
      subtitle: "Tracking Situ Gunung - Museum Prabu Siliwangi",
      price: "IDR 695.000",
      minPax: "min. 4–5pax",
      image: situ,
      group: "paket-wisata",
    ...
    {
      id: "2",
      name: "Pelabuhan Ratu Situ Gunung 2H1M",
      subtitle: "Pantai Citepus - Geyser Cisolok - Tracking Situ Gunung",
      price: "IDR 790.000",
      minPax: "min. 4–5pax",
      image: plara,
      group: "paket-wisata",
    },
    {
      ...
      subtitle: "Tanah Lot - Pantai Dreamland - Pantai Jimbaran",
      price: "IDR 837.000",
      minPax: "min. 2–55pax",
      image: dreamland,
      group: "overland",
    },
    {
      ...
      subtitle: "Pure Ulun Danu Bedugul - Tanah Lot - Pura Luhur Uluwatu",
      price: "IDR 1.260.000",
      minPax: "min. 2–50pax",
      image: lot,
      group: "overland",
    },
    {
      ...
      subtitle: "Kintamani - Tirta Empul - Pura Ulun Danu Bedugul",
      price: "IDR 1.891.000",
      minPax: "min. 2–55pax",
      image: dreamland,
      group: "overland",
    ...
    {
      id: "6",
      name: "Paket Honeymoon Bali 4H",
      subtitle: "Kintamani - Tirta Empul - GWK - Pantai Melasti",
      price: "IDR 1.891.000",
      minPax: "min. 2–55pax",
      image: bali,
      group: "overland",
    ...
    {
      id: "7",
      name: "Paket Honeymoon Bali 3H2M",
      subtitle: "Jimbaran Seafood - Angel’s Billabong - Broken Beach",
      price: "IDR 1.891.000",
      minPax: "min. 2–55pax",
      image: bali,
      group: "overland",
    ...
    {
      id: "8",
      name: "Paket Wisata Karimunjawa 2H1M",
      subtitle: "Spot snorkeling - Pantai tanjung gelam - Alun-alun",
      price: "IDR 670.000",
      minPax: "",
      image: tanjung,
      group: "overland",
    ...
    {
      id: "9",
      name: "Paket Wisata Karimunjawa 3H2M",
      subtitle: "Bukit love - tanjung gelam - Spot nemo - Pulau cemara besar",
      price: "IDR 855.000",
      minPax: "",
      image: tanjung,
      group: "overland",
    ...
    {
      id: "10",
      name: "Paket Wisata Karimunjawa 4H3M",
      subtitle:
        "Bukit love - tanjung gelam - Spot nemo - Pantai bobi - Pantai sunset",
      price: "IDR 1.050.000",
      minPax: "",
      image: tanjung,
      group: "overland",
    ...
    {
      id: "11",
      name: "Paket Honeymoon Karimunjawa 2H1M",
      subtitle: "Bukit love - Pantai tanjung gelam - Alun-alun karimunjawa",
      price: "IDR 5.380.000/Couple",
      minPax: "",
      image: tanjung,
      group: "overland",
    },
    {
      id: "12",
      name: "Paket Honeymoon Karimunjawa 3H2M",
      subtitle: "Bukit love - tanjung gelam - Spot nemo - Pulau cemara besar",
      price: "IDR 6.350.000/Couple",
      minPax: "",
      image: tanjung,
      group: "overland",
    },
    {
      id: "13",
      name: "Paket Honeymoon Karimunjawa 4H3M",
      subtitle:
        "Bukit love - tanjung gelam - Spot nemo - Pantai bobi - Pantai sunset",
      price: "IDR 7.300.000/Couple",
      minPax: "",
      image: tanjung,
      group: "overland",
    },
    {
      id: "14",
      name: "PAKET WISATA LABUAN BAJO 3H2M",
      subtitle:
        "Pulau Kelor - Pulau Manjarite - Pulau Kalong - Pulau Padar - Pink Beach",
      price: "IDR 3.650.000",
      minPax: "",
      image: pink,
      group: "overland",
    ...
    {
      id: "15",
      name: "PAKET WISATA LABUAN BAJO 4H3M",
      subtitle:
        "Pulau Kelor - Pulau Manjarite - Pulau Kalong - Pulau Padar - Pink Beach",
      price: "IDR 4.850.000",
      minPax: "",
    ...
    {
      id: "16",
      name: "PAKET HONEYMOON LABUAN BAJO",
      subtitle:
        "Pulau Kelor - Pulau Manjarite - Pulau Kalong - Pulau Padar - Pink Beach",
      price: "IDR 8.600.000",
      minPax: "",
    ...
    {
      id: "17",
      name: "PAKET A : LOMBOK ONE DAY (Snorkeling Gili Trawangan 1 Hari)",
      subtitle:
        "Gili Trawangan, Gili Air dan Gili Meno - Senggigi - Bukit Malimbu",
      price: "IDR 470.000",
      minPax: "min. 2–10pax",
      image: gili,
      group: "one-day-trip",
    ...
    {
      id: "18",
      name: "PAKET B : LOMBOK ONE DAY ( Explore Gili Trawangan )",
      subtitle:
        "Gili Trawangan, Pass Pusuk ( Monkey Forest ) - Senggigi - Bukit Malimbu",
      price: "IDR 460.000",
      minPax: "min. 2–10pax",
      image: gili,
      group: "one-day-trip",
    ...
    {
      id: "19",
      name: "Paket Tour Lombok 2 Hari 1 Malam (A)",
      subtitle:
        "Gili Trawangan - Kuta Mandalika - Pantai Tanjung Ann - Desa Suku Sasak",
      price: "IDR 780.000",
      minPax: "min. 2–10pax",
      image: gili,
      group: "paket-wisata",
    ...
    {
      id: "20",
      name: "Paket Tour Lombok 2 Hari 1 Malam (B)",
      subtitle: "Pantai Pink - Gili Petelu - Kuta Mandalika - Desa Suku Sasak",
      price: "IDR 750.000",
      minPax: "min. 2–10pax",
      image: pink,
      group: "paket-wisata",
    },
    {
      ...
      subtitle:
        "Kuta Mandalika - Sirkuit Mandalika - Gili Trawangan - Bukit Malimbu",
      price: "IDR 910.000",
      minPax: "min. 2–10pax",
      image: gili,
      group: "paket-wisata",
    ...
    {
      id: "22",
      name: "Paket Tour Lombok 3 Hari 2 Malam (B)",
      subtitle:
        "Kuta Mandalika - Sirkuit Mandalika - Pantai Pink - Gili Petelu",
      price: "IDR 870.000",
      minPax: "min. 2–10pax",
      image: pink,
      group: "paket-wisata",
    ...
    {
      id: "23",
      name: "Paket Tour Lombok 4 Hari 3 Malam (A)",
      subtitle:
        "Kuta Mandalika - Gili Trawangan - Air Terjun Benang Stokel dan Kelambu",
      price: "IDR 1.220.000",
      minPax: "min. 2–10pax",
      image: gili,
      group: "paket-wisata",
    ...
    {
      id: "24",
      name: "Paket Honeymoon Lombok 3H2M",
      subtitle: "Kuta Mandalika - Gili Trawangan - Bukit Malioboro, Senggigi",
      price: "IDR 4.000.000/Couple",
      minPax: "",
      image: gili,
      group: "paket-wisata",
    },
