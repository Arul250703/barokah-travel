...
const Semarang = () => {
    ...
    const fetchPackages = async () => {
      try {
        const res = await axios.get(
          "http://localhost:5000/api/packages?city=Semarang"
        );
  ...
  if (currentFilter === "paket") {
    filteredPackages = [
      ...semarangEventData.capacityBuilding,
      ...semarangEventData.eoWo,
    ];
  } else {
    ...
    <div className="semarang-page">
      <header className="detail-hero-section" style={heroBgStyle}>
        <div className="detail-hero-overlay">
          <h1 className="detail-hero-title">PAKET WISATA SEMARANG</h1>
          <p className="detail-hero-subtitle">Jelajahi keindahan kota lumpia</p>
        </div>
      </header>
            ...
            <div>
              <section className="section">
                ...
                <p className="note">
                  ...
                  <br />
                  • Untuk Reservasi paket lebih dari 20 orang konfirmasi kepada
                  admin barokah tour & travel
              ...
              <section className="section">
                ...
                <p className="note">
                  ...
                  <br />
                  • Harga area kota Semarang (lebih dari 25 km charges: 25% -
                  40%, tergantung lokasi)
                  <br />
                  • Free crew + konsumsi crew, tiket objek wisata, org mineral,
                  P3K Standar, Asuransi peserta, driver guide
                  <br />• Pembayaran melalui rekening bank mandiri :{" "}
                  <b>1820001975030 AN PT BINA BAROKAH SEJAHTERA</b>
                </p>
              </section>
      ...
      <section className="custom-cta">
        ...
        <div className="cta-overlay">
          <div className="cta-text">
            ...
            <a
              href={`https://wa.me/6285930005544?text=Halo, saya tertarik dengan paket di Semarang.`}
